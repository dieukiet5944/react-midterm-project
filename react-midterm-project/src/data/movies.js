const movies = [
    {
        ...
        synopsis:
            "Hodaka, a boy who runs away from his remote island home to Tokyo, finds work writing for a mysterious occult magazine. Amid endless rain, he meets Hina, a cheerful girl with a special power to clear the sky with a prayer.",
    },
    {
        id: "2",
        movieName: "One Piece",
        ...
        synopsis:
            "Gol D. Roger, the Pirate King, reveals the location of the ultimate treasure One Piece before his execution, sparking the Great Pirate Era as countless pirates set sail to find it.",
    },
    {
        id: "3",
        ...
        synopsis:
            "Boruto Uzumaki, son of Naruto, navigates life as a ninja in a new generation alongside friends Sarada and Mitsuki.",
    },
    {
        id: "4",
        ...
        synopsis:
            "Loid Forger helps Anya win a cooking contest at Eden Academy to maintain his spy mission, uncovering a world-threatening secret.",
    },
    {
        id: "5",
        ...
        synopsis:
            "Humanity lives behind massive walls to protect themselves from Titans, giant humanoid creatures that devour people.",
    },
    {
        id: "6",
        ...
        genres: ["Sports"],
        synopsis:
            "Tsubasa Ozora pursues his dream of becoming the world's best soccer player through intense matches and rivalries.",
    },
    {
        id: "7",
        movieName: "Ao Ashi",
        ...
        genres: ["Sports", "Drama"],
        synopsis:
            "Ashito Aoi, a talented young soccer player from the countryside, gets a chance to join a top Tokyo youth team after a setback.",
    },
];
